...
RUN echo '<?xml version="1.0" encoding="UTF-8"?><metadata><groupId>it.marcoreni</groupId><artifactId>nexus3-bitbucketcloud-auth-plugin</artifactId><versioning><release>docker</release><versions><version>docker</version></versions><lastUpdated>20170630132608</lastUpdated></versioning></metadata>' > /opt/sonatype/nexus/system/it/marcoreni/nexus3-bitbucketcloud-auth-plugin/maven-metadata-local.xml
